...
void BMP180_Init(void) {
    ...
    RETURN_IF_ERROR_CODE_HEALTH(HAL_I2C_Mem_Read(&hi2c1, BMP180_I2C_DEVICE_ADDR, 0xD0, I2C_MEMADD_SIZE_8BIT, &chip_id, 1, 100), &healthFlags.bmp180);
    if (chip_id == 0x55) {
...
static void BMP180_ReadCalibrationData(void) {
    ...
    HAL_StatusTypeDef errCode;
    RETURN_IF_ERROR_CODE_HEALTH(HAL_I2C_Mem_Read(&hi2c1, BMP180_I2C_DEVICE_ADDR, BMP180_REG_AC1_MSB, I2C_MEMADD_SIZE_8BIT, calib_raw, 22, 100), &healthFlags.bmp180);
...
float BMP180_GetTemperature(void) {
    ...
    HAL_StatusTypeDef errCode;
    RETURN_IF_ERROR_CODE_HEALTH(HAL_I2C_Mem_Write(&hi2c, BMP180_I2C_DEVICE_ADDR, BMP180_REG_CONTROl, I2C_MEMADD_SIZE_8BIT, BMP180_TEMP_CMD, 1,100), &healthFlags.bmp180);
...
static float BMP180_ReadUncompTemp(void) {
    ...
    RETURN_IF_ERROR_CODE_HEALTH(HAL_I2C_Mem_Read(&hi2c,BMP180_I2C_DEVICE_ADDR,BMP180_REG_DATA_MSB,I2C_MEMADD_SIZE_8BIT,&msb,1,100), &healthFlags.bmp180);
    RETURN_IF_ERROR_CODE_HEALTH(HAL_I2C_Mem_Read(&hi2c,BMP180_I2C_DEVICE_ADDR,BMP180_REG_DATA_LSB,I2C_MEMADD_SIZE_8BIT,&lsb,1,100), &healthFlags.bmp180);
    return (msb << 8) + lsb;
}
...
float BMP180_GetPressure(void) {
    // Write command to control register
    HAL_StatusTypeDef errCode;
    RETURN_IF_ERROR_CODE_HEALTH(HAL_I2C_Mem_Write(&hi2c, BMP180_I2C_DEVICE_ADDR, BMP180_REG_CONTROl, I2C_MEMADD_SIZE_8BIT, BMP180_PRESSURE_CMD,1,100), &healthFlags.bmp180);
...
static float BMP180_ReadUncompPressure(void) {
    ...
    RETURN_IF_ERROR_CODE_HEALTH(HAL_I2C_Mem_Read(&hi2c,BMP180_I2C_DEVICE_ADDR,BMP180_REG_DATA_MSB,I2C_MEMADD_SIZE_8BIT,&msb,1,100), &healthFlags.bmp180);
    RETURN_IF_ERROR_CODE_HEALTH(HAL_I2C_Mem_Read(&hi2c,BMP180_I2C_DEVICE_ADDR,BMP180_REG_DATA_LSB,I2C_MEMADD_SIZE_8BIT,&lsb,1,100), &healthFlags.bmp180);
    RETURN_IF_ERROR_CODE_HEALTH(HAL_I2C_Mem_Read(&hi2c,BMP180_I2C_DEVICE_ADDR,BMP180_REG_DATA_XLSB,I2C_MEMADD_SIZE_8BIT,&xlsb,1,100), &healthFlags.bmp180);
